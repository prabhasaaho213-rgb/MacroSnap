...
class MealStore {
  ...
  Future<void> load() async {
    ...
    try {
      ...
      if (await file.exists()) {
        ...
        _meals = data.map((e) => MealRecord.fromJson(e as Map<String, dynamic>)).toList();
      }
    } catch (e) {
      debugPrint('MealStore: Failed to load meals: $e');
    }
    _loaded = true;
  }
  ...
  Future<void> _save() async {
    try {
      ...
      debugPrint('MealStore: Failed to save meals: $e');
    }
  }
}
